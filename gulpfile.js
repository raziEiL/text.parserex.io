...
gulp.task("build", gulp.series(["clean", "build:sass", "build:js", "build:img", "build:html"]));
gulp.task("build-dev", gulp.series(["clean", "build-dev:sass", "build:js", "build:img", "build:html"]));
